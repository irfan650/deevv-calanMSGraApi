...
public class Constants {
    ...
    public static final String SCOPES = "openid profile mail.send mail.read Calendars.Read Calendars.Read.Shared Calendars.ReadWrite Calendars.ReadWrite.Shared";
}
