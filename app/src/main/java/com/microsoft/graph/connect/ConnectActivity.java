...
// start the MeetingActivity
            Intent MeetingActivity =
                    new Intent(ConnectActivity.this, MeetingActivity.class);

            // take the user's info along
            //MeetingActivity.putExtra(SendMailActivity.ARG_GIVEN_NAME, name);
            //MeetingActivity.putExtra(SendMailActivity.ARG_DISPLAY_ID, preferredUsername);
